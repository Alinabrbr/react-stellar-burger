...
export default function Register(): JSX.Element {
    ...
    function registerProfile(event: React.FormEvent<HTMLFormElement>) {
    ...
    return (
        <div className={styles.formContainer}>
            ...
            <form className={styles.form} onSubmit={registerProfile}>
                ...
                <EmailInput id='email' placeholder='E-mail' value={email} autoComplete='email'
                       onChange={(event) => setEmail(event.target.value)}/>

                <PasswordInput id='password' placeholder='Пароль' value={password} autoComplete='new-password'
